  ...
  plugins: [
    react(),
    {
      ...
      transformIndexHtml(html) {
        // REMOVENDO COMPLETAMENTE A LÓGICA DA MARCA D'ÁGUA (OPÇÃO 1)
        return [
          {
            tag: "script",
            attrs: { type: "module" },
        ...
        // REMOVENDO A CONDIÇÃO PARA NUNCA INJETAR A MARCA D'ÁGUA (OPÇÃO 2 - COMENTADA)
        // if (false) {
        //   return [
        //     {
        //       tag: "style",
        ...
        //         watermark.href = 'https://getmocha.com?a_id=' + encodeURIComponent('0195e1c2-c1f9-78bf-ab32-a30a16686cb7');
        ...
        // REMOVENDO A LÓGICA APENAS PARA O AMBIENTE DE PRODUÇÃO (OPÇÃO 3 - COMENTADA)
        ...
        // Retorna o script de relatório de erros (mantido em todas as opções)
        return [
          {
            tag: "script",
            attrs: { type: "module" },
